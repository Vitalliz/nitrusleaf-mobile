...
export const DonutChart: React.FC<DonutChartProps> = ({
  ...
  return (
    <View style={styles.wrapper}><View style={styles.row}><View style={[styles.chartWrapper, { width: size, height: size }]}>
          <Svg width={size} height={size}><Circle
              cx={radius}
              cy={radius}
              r={centerRadius}
              stroke="#F0F0F0"
          ...
          </Svg><View style={styles.centerTextWrapper} pointerEvents="none">
          ...
          <View style={styles.legend}>
            {data.map((item, index) => (
              <View key={index} style={styles.legendRow}><View style={[styles.badge, { backgroundColor: item.color }]}>
                  <Text style={styles.badgeText}>{item.percentage}%</Text>
                </View><Text style={styles.legendName}>{item.name}</Text><Text style={styles.legendValue}>{item.value}</Text>
              </View>
            ))}
          </View>
        )}
