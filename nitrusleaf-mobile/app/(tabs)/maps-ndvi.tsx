    ...
    <Background>
      ...
      <View style={styles.mapContainer}>
        <MapView
          ...
          mapType="standard" // Mapa satélite igual ao anterior
        >
          <Marker
            coordinate={{ latitude: -24.751441, longitude: -47.81431 }}
            title="Propriedade 1"
      ...
      {/* Footer com espaço para o botão voltar */}
      <View style={styles.footer}>
        <TouchableOpacity
          style={styles.footerBackButton}
          onPress={() => router.push("/(tabs)/maps")}
        >
          <Text style={styles.footerBackArrow}>←</Text>
