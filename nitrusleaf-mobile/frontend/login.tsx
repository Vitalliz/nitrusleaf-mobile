...
export default function LoginScreen() {
    ...
    return (
        ...
        <KeyboardAvoidingView
            ...
            style={{ flex: 1 }}
        >
            <View style={styles.container}><View style={styles.iconsBox}>
                    <TouchableOpacity 
                ...
                <View style={styles.form}>
                    ...
                    />
                    </View><View style={styles.formInput}>
                ...
                </View><LoginButton  onPress={handleLogin} disabled={isAuthPending} />
                ...
                </View><View style={styles.registerContainer}>
        ...
        </KeyboardAvoidingView><View style={styles.waveContainer}>
        <WaveBg 
            width={screenWidth} 
            height={140} 
