...
export default function AccountConfigScreen() {
    ...
    return (
        ...
        <SafeAreaView style={styles.safeArea}>
            <StatusBar barStyle="dark-content" backgroundColor="#FAF1E5" /><View style={styles.header}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}><View style={styles.formContainer}>
                <Text style={styles.sectionTitle}>Credenciais de Acesso</Text><View style={styles.formGroup}>
                ...
                </View><View style={styles.dangerZone}>
