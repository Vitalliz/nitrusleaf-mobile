        ...
        <Background>
            <SafeAreaView style={styles.safeArea}  edges={[ 'left', 'right']}>
                ...
                ><View style={styles.header}>
                    ...
                    </View><View style={styles.profileCard}><TouchableOpacity
