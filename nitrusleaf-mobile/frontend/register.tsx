...
export default function RegisterScreen() {
  ...
  return (
    <Background>
        ...
        <View style={styles.container}><View style={styles.iconsBox}>
          ...
          <View style={styles.form}>{step === 1 && (
              <View style={styles.stepContainer}>
                ...
                <Text style={styles.label}>CPF</Text><Input
              ...
              <View style={styles.stepContainer}>
                <WelcomeTitle text="Cadastro"/>
                <WelcomeSubtitle text="Dados da Propriedade"/>
                <Text style={[styles.label, { marginTop: 25 }]}>CEP</Text><Input
      ...
      </ScrollView><View style={styles.waveContainer}>
        <WaveBg 
          width={screenWidth} 
          height={140} 
